...
# os.chdir(os.pardir)
os.chdir('temp_data')
train_data = np.load('train_data%s_1000.npy'%mid_fix)
test_data = np.load('test_data%s_1000.npy'%mid_fix)
train_label = np.load('train_label%s_1000.npy'%mid_fix)
test_label = np.load('test_label%s_1000.npy'%mid_fix)
os.chdir(os.pardir)
